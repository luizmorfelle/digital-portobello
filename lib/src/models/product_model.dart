...
class ProductModel extends CardItemModel {
  ...
  static ProductModel fromJson(Map<String, dynamic> json) {
    return ProductModel(
        ...
        qtPcCamada: json['QtPcCamada'],
        qtPcPalletMi: json['QtPcPalletMi'],
        qtM2PalletMi: json['QtM2PalletMi'],
        qtCaixaPalletMi: json['QtCaixaPalletMi'],
        qtPesoLiquido: json['QtPesoLiquido'],
        qtPesoBruto: json['QtPesoBruto'],
        codVariacaoTonalidade: json['CodVariacaoTonalidade'],
        precoPeca: json['PrecoPeca'],
        valorPalete: json['ValorPalete'],
        precoCaixa: json['PrecoCaixa'],
        qtdPesoLiqPeca: json['QtdPesoLiqPeca'],
        ...
        eanCx: json['EanCx'],
        eanPc: json['EanPc'],
        resultadoMinimoManchantes: json['ResultadoMinimoManchantes'],
